...
namespace qmj
{
	...
	public:
		...
		typedef rb_tree<map_traits<key_type, data_type, Compare, Alloc, false>> base_type;
		...
		map(const std::initializer_list<value_type>&lst) :
			base_type(lst)
		{
		}
	...
	template<typename key_type,
		...
		void swap(map<key_type, data_type, Compare, Alloc>&left,
...
namespace qmj
{
	...
	public:
		...
		typedef rb_tree<map_traits<key_type, data_type, Compare, Alloc, true>> base_type;
	...
	template<typename key_type,
		...
		typename Compare,
		typename Alloc>inline
		void swap(multimap<key_type, data_type, Compare, Alloc>&left,
