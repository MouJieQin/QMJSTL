...
namespace qmj
{
template <typename key_type_, typename data_type, typename Compare,
...
template <typename key_type_, typename data_type_,
          typename Compare = std::less<key_type_>,
...
template <typename key_type_, typename data_type_,
          ...
          typename Alloc = qmj::allocator<std::pair<const key_type_, data_type_>>>
class multimap
    : public rb_tree<map_traits<key_type_, data_type_, Compare, Alloc, true>>
{
public:
  typedef key_type_ key_type;
  typedef data_type_ data_type;
