...
namespace qmj
{
	template<typename value_type, value_type val>
...
namespace qmj
{
	...
	struct iterator_traits_base<Iter,
		void_t<typename Iter::iterator_category,
	...
	template<typename value_type, typename = void>
	struct is_pod :
		bool_type<type_traits<value_type>::is_POD_type::value
		|| If<is_typedef_pod<value_type>::value,
		typename is_typedef_pod<value_type>::type, false_type>::type::value>
	{
	};

	template<typename Iter, typename = void>
	struct is_typedef_mem_copy :
		false_type
	{
		typedef false_type type;
	};
	...
	template<typename Iter, typename = void>
	struct is_mem_copy :
		bool_type<iterator_traits<Iter>::memory_copy_tag::value
		|| If<is_typedef_mem_copy<Iter>::value,
		typename is_typedef_mem_copy<Iter>::type, false_type>::type::value>
	{
	};
