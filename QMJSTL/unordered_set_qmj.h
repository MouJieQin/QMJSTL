...
template <typename key_type, typename HashFunction = qmj::hash<key_type>,
          typename EqualKey = std::equal_to<key_type>,
          typename Alloc = qmj::allocator<key_type>>
class unordered_set
    : public hashtable<
          uset_traits<key_type, HashFunction, EqualKey, Alloc, false>> {
 public:
  typedef hashtable<uset_traits<key_type, HashFunction, EqualKey, Alloc, false>>
      base_type;
...
class unordered_multiset
    : public hashtable<
          uset_traits<key_type, HashFunction, EqualKey, Alloc, true>> {
 public:
  typedef hashtable<uset_traits<key_type, HashFunction, EqualKey, Alloc, true>>
      base_type;
